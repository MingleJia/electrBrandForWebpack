...
class CampusDetail extends Component{
    ...
    prevBtn = () => {
        ...
        campusDetailId < 1 ? campusDetailId = campusList.length-1 : campusDetailId = campusDetailId - 1;
        this.setState({
            compusContent: campusList[campusDetailId]
        })
    ...
    nextBtn = () => {
        let { campusDetailId } = this.props.root;
        let { campusList } = this.state;
        campusDetailId >= campusList.length-1 ? campusDetailId = 0 : campusDetailId = campusDetailId + 1;
        this.setState({
            compusContent: campusList[campusDetailId]
        })
        this.props.setCampusStyle({
