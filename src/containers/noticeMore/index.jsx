...
class Notice extends Component{
    ...
    componentDidMount(){
        let noticeList = [
            {
                title:'<p>noticenoticenoticenoticenoticenoticenotice</p><h3>1111</h3><img src="https://static.leke.cn/images/common/blank.png" />',
            },
            {
                title:'222<img src="https://static.leke.cn/images/common/blank.png" />',
            },
            {
                title:113331,
            },
                            ...
                            noticeList.length !== 0 && noticeList.map((item,index)=>{
                                return(
                                    <li className={styles['content']} key={index}>
                                        ...
                                        <div className={`${ arrExpan.includes(index) ? styles['detail'] : styles['detailHidden'] }`} dangerouslySetInnerHTML={{__html:`${item.title}`}}>
